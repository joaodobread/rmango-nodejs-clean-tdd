...
const makAddAccountRepository = (): AddAccountRepository => {
...
const makeSut = (): SutTypes => {
  ...
  const addAccountRepositoryStub = makAddAccountRepository()
...
describe('DbAddAccount UseCase', () => {
  ...
  test('should reutrn an account on success', async () => {
    const { sut } = makeSut()
    const accountData = {
      name: 'valid_name',
      email: 'valid_email',
